...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2/1980/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2/1981/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2/1982/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2/1983/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v2_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2/1984/' \
    --start_idx 0 \
    --stride_sample 1 
