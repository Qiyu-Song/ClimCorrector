...
python preprocessing/compute_norm_stats_simple_v2.py \
  --input_h5 /n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2_35year_sub23/train_input.h5 \
  --target_dc_h5 /n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2_35year_sub23/train_target_dc.h5 \
  --target_sum_h5 /n/home03/qiyusong/scratch/climcorr_preprocessing/v2_iter2_35year_sub23/train_target_sum.h5 \
