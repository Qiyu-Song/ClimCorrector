...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2010/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2011/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2012/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2013/' \
    --start_idx 0 \
    --stride_sample 1 
...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    ...
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2014/' \
    --start_idx 0 \
    --stride_sample 1 
