...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter3.cam.h1.2000-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2000/' \
    --start_idx 0 \
    --stride_sample 1 

python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter3.cam.h1.2001-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2001/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter3.cam.h1.2002-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2002/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter3.cam.h1.2003-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2003/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter3.cam.h1.2004-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/2004/' \
    --start_idx 0 \
    --stride_sample 1 
