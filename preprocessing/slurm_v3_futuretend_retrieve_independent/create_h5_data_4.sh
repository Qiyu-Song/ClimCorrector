...
python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter2.cam.h1.1995-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/1995/' \
    --start_idx 0 \
    --stride_sample 1 

python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter2.cam.h1.1996-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/1996/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter2.cam.h1.1997-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/1997/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter2.cam.h1.1998-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/1998/' \
    --start_idx 0 \
    --stride_sample 1 


python preprocessing/create_h5_data_v3_futuretend_retrieve_independent.py \
    'fixreplay_2iter2.cam.h1.1999-*.nc' \
    --data_path '/n/home04/sweidman/holylfs06/CESM215_out/Run/archive/fixreplay_2iter1/atm/hist/' \
    --save_path '/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend/1999/' \
    --start_idx 0 \
    --stride_sample 1 
