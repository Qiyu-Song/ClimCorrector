...
def preprocess_climcorr_val_data():
    ...
    """
    parent_path = f'/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend_4year_sub3/'
    ...
    target_path = f'/n/home03/qiyusong/scratch/climcorr_preprocessing/v3_futuretend_4year_sub3_processed/'
