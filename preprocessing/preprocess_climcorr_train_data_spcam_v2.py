...
def preprocess_climcorr_train_data(year):
    ...
    """
    parent_path = f'/n/home03/qiyusong/scratch/climcorr_preprocessing/spcam_v2_iter2/{year}/'
    ...
    target_path = f'/n/home03/qiyusong/scratch/climcorr_preprocessing/spcam_v2_iter2_processed/{year}/'
