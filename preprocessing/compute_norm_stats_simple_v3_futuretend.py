...
def main():
    ...
    save_npy(os.path.join(inputs_dir, "input_mean_v3_futuretend_35year_sub23.npy"), in_mean)
    save_npy(os.path.join(inputs_dir, "input_std_v3_futuretend_35year_sub23.npy"),  in_std)

    save_npy(os.path.join(outputs_dir, "target_dc_mean_v3_futuretend_35year_sub23.npy"), dc_mean)
    save_npy(os.path.join(outputs_dir, "target_dc_std_v3_futuretend_35year_sub23.npy"),  dc_std)
    save_npy(os.path.join(outputs_dir, "target_sum_mean_v3_futuretend_35year_sub23.npy"), sm_mean)
    save_npy(os.path.join(outputs_dir, "target_sum_std_v3_futuretend_35year_sub23.npy"),  sm_std)
