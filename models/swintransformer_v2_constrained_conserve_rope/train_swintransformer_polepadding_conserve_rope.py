...
def main(cfg: DictConfig) -> float:
    ...
    model = SwinTransformerV2CrModulus_polepadding_conserve(
        img_size= (96, 144),
        patch_size = 1,
        ...
        init_values = cfg.swin.init_values,
        ...
        conserve_water = cfg.swin.conserve_water,
        conserve_heat = cfg.swin.conserve_heat,
